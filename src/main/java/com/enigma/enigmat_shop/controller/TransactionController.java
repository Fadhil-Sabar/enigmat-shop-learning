...
public class TransactionController {
    ...
    @PostMapping("/insert")
    public ResponseEntity<WebResponse<Purchase>> newTransaction(@RequestBody Purchase purchase){
        Purchase transaction = purchaseService.transaction(purchase);
        WebResponse<Purchase> response = new WebResponse<>("Transaction success", transaction);
